    ...
    <View style={styles.block}>
      ...
      <View style={styles.profile}>
        <View style={{ marginBottom: 15, flexDirection: 'row',justifyContent: 'space-between', }}>
          ...
          <View>
            <Text style={{ color: "#525252", fontSize: 16 }}>Họ và tên</Text>
            <Text style={{ color: "#525252", fontSize: 16 }}>Ngày sinh</Text>
            <Text style={{ color: "#525252", fontSize: 16 }}>Giới tính</Text>
            <Text style={{ color: "#525252", fontSize: 16 }}>Dân tộc</Text>
            <Text style={{ color: "#525252", fontSize: 16 }}>Quốc gia</Text>
            <Text style={{ color: "#525252", fontSize: 16 }}>Chiều cao</Text>
            <Text style={{ color: "#525252", fontSize: 16 }}>Cân nặng</Text>
            <Text style={{ color: "#525252", fontSize: 16 }}>Nhóm máu</Text>
            <Text style={{ color: "#525252", fontSize: 16 }}>Nghề nghiệp</Text>

          </View>
          <View>
            <Text style={{ color: "#525252", fontSize: 16 }}>Nguyễn Anh Tuấn</Text>
            <Text style={{ color: "#525252", fontSize: 16 }}>23 tháng 09 năm 1991</Text>
            <Text style={{ color: "#525252", fontSize: 16 }}>Nam</Text>
            <Text style={{ color: "#525252", fontSize: 16 }}>Kinh</Text>
            <Text style={{ color: "#525252", fontSize: 16 }}>Việt Nam</Text>
            <Text style={{ color: "#525252", fontSize: 16 }}>1m70</Text>
            <Text style={{ color: "#525252", fontSize: 16 }}>70kg</Text>
            <Text style={{ color: "#525252", fontSize: 16 }}>O</Text>
            <Text style={{ color: "#525252", fontSize: 16 }}>Quản lý</Text>
          </View>
        </View>
      ...
      <View style={{
        width: "100%", height: 200, paddingHorizontal: 15,

      }}>
        <View style={{ paddingHorizontal: 30 }}>
          <Text style={{ fontSize: 12, color: '#666666' }}>HÌNH ẢNH</Text>
        </View>
