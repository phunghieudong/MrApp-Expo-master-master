...
import {
  ...
  ListVaccinesDetailRegisterScreen,
  DemoScreen,
  TermOfMedicalDetailScreen
} from "@/views";
...
const ProfileStackNavigator = () => {
  return (
    ...
    >
      ...
      <Stack.Screen name="Surgery" component={SurgeryScreen} />

      <Stack.Screen name="AdviseMenu" component={AdviseMenuScreen} />
      ...
      <Stack.Screen name="ListVaccinesDetailRegister" component={ListVaccinesDetailRegisterScreen} />
      ...
      <Stack.Screen name="TermOfMedicalDetail" component={TermOfMedicalDetailScreen} />
